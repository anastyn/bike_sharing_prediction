A simple neural network (with a single hidden layer) that estimates the number of bikes which are going to be rented next year based on the historical information from the previous years.
